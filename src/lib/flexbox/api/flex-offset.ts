...
export class FlexOffsetDirective extends BaseFxDirective implements OnInit, OnChanges, OnDestroy {
  ...
  @Input('fxFlexOffset.handset')           set handset(val)           { this._cacheInput('offsetHandset', val); };
  @Input('fxFlexOffset.handset.landscape') set handsetLandscape(val)  { this._cacheInput('offsetHandsetLandscape', val) };
  @Input('fxFlexOffset.handset.portrait')  set handsetPortrait(val)   { this._cacheInput('offsetHandsetPortrait', val); };
  @Input('fxFlexOffset.tablet')            set tablet(val)            { this._cacheInput('offsetTablet', val); };
  @Input('fxFlexOffset.tablet.landscape')  set tabletLandscape(val)   { this._cacheInput('offsetTabletLandscape', val); };
  @Input('fxFlexOffset.tablet.portrait')   set tabletPortrait(val)    { this._cacheInput('offsetTabletPortrait', val); };
  @Input('fxFlexOffset.web')               set web(val)               { this._cacheInput('offsetWeb', val); };
  @Input('fxFlexOffset.web.landscape')     set webLandscape(val)      { this._cacheInput('offsetWebLandscape', val); };
  @Input('fxFlexOffset.web.portrait')      set webPortrait(val)       { this._cacheInput('offsetWebPortrait', val); };
