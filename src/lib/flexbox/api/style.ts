...
export class StyleDirective extends NgStyle implements OnInit, OnChanges, OnDestroy {
  ...
  @Input('ngStyle.handset')           set handset(val)           { this._base.cacheInput('styleHandset', val); };
  @Input('ngStyle.handset.landscape') set handsetLandscape(val)  { this._base.cacheInput('styleHandsetLandscape', val) };
  @Input('ngStyle.handset.portrait')  set handsetPortrait(val)   { this._base.cacheInput('styleHandsetPortrait', val); };
  @Input('ngStyle.tablet')            set tablet(val)            { this._base.cacheInput('styleTablet', val); };
  @Input('ngStyle.tablet.landscape')  set tabletLandscape(val)   { this._base.cacheInput('styleTabletLandscape', val); };
  @Input('ngStyle.tablet.portrait')   set tabletPortrait(val)    { this._base.cacheInput('styleTabletPortrait', val); };
  @Input('ngStyle.web')               set web(val)               { this._base.cacheInput('styleWeb', val); };
  @Input('ngStyle.web.landscape')     set webLandscape(val)      { this._base.cacheInput('styleWebLandscape', val); };
  @Input('ngStyle.web.portrait')      set webPortrait(val)       { this._base.cacheInput('styleWebPortrait', val); };
